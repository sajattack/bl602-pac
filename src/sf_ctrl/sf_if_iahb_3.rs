#[doc = "Reader of register sf_if_iahb_3"]
pub type R = crate::R<u32, super::SF_IF_IAHB_3>;
#[doc = "Writer for register sf_if_iahb_3"]
pub type W = crate::W<u32, super::SF_IF_IAHB_3>;
#[doc = "Register sf_if_iahb_3 `reset()`'s with value 0"]
impl crate::ResetValue for super::SF_IF_IAHB_3 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Reader of field `sf_if_2_qpi_mode_en`"]
pub type SF_IF_2_QPI_MODE_EN_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `sf_if_2_qpi_mode_en`"]
...
#[doc = "Reader of field `sf_if_2_spi_mode`"]
pub type SF_IF_2_SPI_MODE_R = crate::R<u8, u8>;
#[doc = "Write proxy for field `sf_if_2_spi_mode`"]
...
#[doc = "Reader of field `sf_if_2_cmd_en`"]
pub type SF_IF_2_CMD_EN_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `sf_if_2_cmd_en`"]
...
#[doc = "Reader of field `sf_if_2_adr_en`"]
pub type SF_IF_2_ADR_EN_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `sf_if_2_adr_en`"]
...
#[doc = "Reader of field `sf_if_2_dmy_en`"]
pub type SF_IF_2_DMY_EN_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `sf_if_2_dmy_en`"]
...
#[doc = "Reader of field `sf_if_2_dat_en`"]
pub type SF_IF_2_DAT_EN_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `sf_if_2_dat_en`"]
...
#[doc = "Reader of field `sf_if_2_dat_rw  `"]
pub type SF_IF_2_DAT_RW_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `sf_if_2_dat_rw  `"]
...
#[doc = "Reader of field `sf_if_2_cmd_byte`"]
pub type SF_IF_2_CMD_BYTE_R = crate::R<u8, u8>;
#[doc = "Write proxy for field `sf_if_2_cmd_byte`"]
...
#[doc = "Reader of field `sf_if_2_adr_byte`"]
pub type SF_IF_2_ADR_BYTE_R = crate::R<u8, u8>;
#[doc = "Write proxy for field `sf_if_2_adr_byte`"]
...
#[doc = "Reader of field `sf_if_2_dmy_byte`"]
pub type SF_IF_2_DMY_BYTE_R = crate::R<u8, u8>;
#[doc = "Write proxy for field `sf_if_2_dmy_byte`"]
