#[doc = "Reader of register sf3_if_io_dly_3"]
pub type R = crate::R<u32, super::SF3_IF_IO_DLY_3>;
#[doc = "Writer for register sf3_if_io_dly_3"]
pub type W = crate::W<u32, super::SF3_IF_IO_DLY_3>;
#[doc = "Register sf3_if_io_dly_3 `reset()`'s with value 0"]
impl crate::ResetValue for super::SF3_IF_IO_DLY_3 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Reader of field `sf3_io_2_do_dly_sel`"]
pub type SF3_IO_2_DO_DLY_SEL_R = crate::R<u8, u8>;
#[doc = "Write proxy for field `sf3_io_2_do_dly_sel`"]
...
#[doc = "Reader of field `sf3_io_2_di_dly_sel`"]
pub type SF3_IO_2_DI_DLY_SEL_R = crate::R<u8, u8>;
#[doc = "Write proxy for field `sf3_io_2_di_dly_sel`"]
...
#[doc = "Reader of field `sf3_io_2_oe_dly_sel`"]
pub type SF3_IO_2_OE_DLY_SEL_R = crate::R<u8, u8>;
#[doc = "Write proxy for field `sf3_io_2_oe_dly_sel`"]
