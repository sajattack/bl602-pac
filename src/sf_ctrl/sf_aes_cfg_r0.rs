#[doc = "Reader of register sf_aes_cfg_r0"]
pub type R = crate::R<u32, super::SF_AES_CFG_R0>;
#[doc = "Writer for register sf_aes_cfg_r0"]
pub type W = crate::W<u32, super::SF_AES_CFG_R0>;
#[doc = "Register sf_aes_cfg_r0 `reset()`'s with value 0"]
impl crate::ResetValue for super::SF_AES_CFG_R0 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Reader of field `sf_aes_region_r0_lock`"]
pub type SF_AES_REGION_R0_LOCK_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `sf_aes_region_r0_lock`"]
...
#[doc = "Reader of field `sf_aes_region_r0_en`"]
pub type SF_AES_REGION_R0_EN_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `sf_aes_region_r0_en`"]
...
#[doc = "Reader of field `sf_aes_region_r0_hw_key_en`"]
pub type SF_AES_REGION_R0_HW_KEY_EN_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `sf_aes_region_r0_hw_key_en`"]
...
#[doc = "Reader of field `sf_aes_region_r0_start`"]
pub type SF_AES_REGION_R0_START_R = crate::R<u16, u16>;
#[doc = "Write proxy for field `sf_aes_region_r0_start`"]
...
#[doc = "Reader of field `sf_aes_region_r0_end`"]
pub type SF_AES_REGION_R0_END_R = crate::R<u16, u16>;
#[doc = "Write proxy for field `sf_aes_region_r0_end`"]
