#[doc = "Reader of register sf3_if_io_dly_0"]
pub type R = crate::R<u32, super::SF3_IF_IO_DLY_0>;
#[doc = "Writer for register sf3_if_io_dly_0"]
pub type W = crate::W<u32, super::SF3_IF_IO_DLY_0>;
#[doc = "Register sf3_if_io_dly_0 `reset()`'s with value 0"]
impl crate::ResetValue for super::SF3_IF_IO_DLY_0 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Reader of field `sf3_dqs_do_dly_sel`"]
pub type SF3_DQS_DO_DLY_SEL_R = crate::R<u8, u8>;
#[doc = "Write proxy for field `sf3_dqs_do_dly_sel`"]
...
#[doc = "Reader of field `sf3_dqs_di_dly_sel`"]
pub type SF3_DQS_DI_DLY_SEL_R = crate::R<u8, u8>;
#[doc = "Write proxy for field `sf3_dqs_di_dly_sel`"]
...
#[doc = "Reader of field `sf3_dqs_oe_dly_sel`"]
pub type SF3_DQS_OE_DLY_SEL_R = crate::R<u8, u8>;
#[doc = "Write proxy for field `sf3_dqs_oe_dly_sel`"]
...
#[doc = "Reader of field `sf3_clk_out_dly_sel`"]
pub type SF3_CLK_OUT_DLY_SEL_R = crate::R<u8, u8>;
#[doc = "Write proxy for field `sf3_clk_out_dly_sel`"]
...
#[doc = "Reader of field `sf3_cs_dly_sel`"]
pub type SF3_CS_DLY_SEL_R = crate::R<u8, u8>;
#[doc = "Write proxy for field `sf3_cs_dly_sel`"]
