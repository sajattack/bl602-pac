#[doc = "Reader of register pwm1_interrupt"]
pub type R = crate::R<u32, super::PWM1_INTERRUPT>;
#[doc = "Writer for register pwm1_interrupt"]
pub type W = crate::W<u32, super::PWM1_INTERRUPT>;
#[doc = "Register pwm1_interrupt `reset()`'s with value 0"]
impl crate::ResetValue for super::PWM1_INTERRUPT {
    type Type = u32;
    #[inline(always)]
