#[doc = "Reader of register pwm2_period"]
pub type R = crate::R<u32, super::PWM2_PERIOD>;
#[doc = "Writer for register pwm2_period"]
pub type W = crate::W<u32, super::PWM2_PERIOD>;
#[doc = "Register pwm2_period `reset()`'s with value 0"]
impl crate::ResetValue for super::PWM2_PERIOD {
    type Type = u32;
    #[inline(always)]
