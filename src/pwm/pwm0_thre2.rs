#[doc = "Reader of register pwm0_thre2"]
pub type R = crate::R<u32, super::PWM0_THRE2>;
#[doc = "Writer for register pwm0_thre2"]
pub type W = crate::W<u32, super::PWM0_THRE2>;
#[doc = "Register pwm0_thre2 `reset()`'s with value 0"]
impl crate::ResetValue for super::PWM0_THRE2 {
    type Type = u32;
    #[inline(always)]
