#[doc = "Reader of register pwm1_clkdiv"]
pub type R = crate::R<u32, super::PWM1_CLKDIV>;
#[doc = "Writer for register pwm1_clkdiv"]
pub type W = crate::W<u32, super::PWM1_CLKDIV>;
#[doc = "Register pwm1_clkdiv `reset()`'s with value 0"]
impl crate::ResetValue for super::PWM1_CLKDIV {
    type Type = u32;
    #[inline(always)]
