#[doc = "Reader of register pwm3_period"]
pub type R = crate::R<u32, super::PWM3_PERIOD>;
#[doc = "Writer for register pwm3_period"]
pub type W = crate::W<u32, super::PWM3_PERIOD>;
#[doc = "Register pwm3_period `reset()`'s with value 0"]
impl crate::ResetValue for super::PWM3_PERIOD {
    type Type = u32;
    #[inline(always)]
