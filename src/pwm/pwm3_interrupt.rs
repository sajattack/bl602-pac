#[doc = "Reader of register pwm3_interrupt"]
pub type R = crate::R<u32, super::PWM3_INTERRUPT>;
#[doc = "Writer for register pwm3_interrupt"]
pub type W = crate::W<u32, super::PWM3_INTERRUPT>;
#[doc = "Register pwm3_interrupt `reset()`'s with value 0"]
impl crate::ResetValue for super::PWM3_INTERRUPT {
    type Type = u32;
    #[inline(always)]
