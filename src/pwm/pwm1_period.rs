#[doc = "Reader of register pwm1_period"]
pub type R = crate::R<u32, super::PWM1_PERIOD>;
#[doc = "Writer for register pwm1_period"]
pub type W = crate::W<u32, super::PWM1_PERIOD>;
#[doc = "Register pwm1_period `reset()`'s with value 0"]
impl crate::ResetValue for super::PWM1_PERIOD {
    type Type = u32;
    #[inline(always)]
