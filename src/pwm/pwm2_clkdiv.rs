#[doc = "Reader of register pwm2_clkdiv"]
pub type R = crate::R<u32, super::PWM2_CLKDIV>;
#[doc = "Writer for register pwm2_clkdiv"]
pub type W = crate::W<u32, super::PWM2_CLKDIV>;
#[doc = "Register pwm2_clkdiv `reset()`'s with value 0"]
impl crate::ResetValue for super::PWM2_CLKDIV {
    type Type = u32;
    #[inline(always)]
