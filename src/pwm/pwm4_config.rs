#[doc = "Reader of register pwm4_config"]
pub type R = crate::R<u32, super::PWM4_CONFIG>;
#[doc = "Writer for register pwm4_config"]
pub type W = crate::W<u32, super::PWM4_CONFIG>;
#[doc = "Register pwm4_config `reset()`'s with value 0"]
impl crate::ResetValue for super::PWM4_CONFIG {
    type Type = u32;
    #[inline(always)]
