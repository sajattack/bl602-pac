#[doc = "Reader of register pwm2_config"]
pub type R = crate::R<u32, super::PWM2_CONFIG>;
#[doc = "Writer for register pwm2_config"]
pub type W = crate::W<u32, super::PWM2_CONFIG>;
#[doc = "Register pwm2_config `reset()`'s with value 0"]
impl crate::ResetValue for super::PWM2_CONFIG {
    type Type = u32;
    #[inline(always)]
