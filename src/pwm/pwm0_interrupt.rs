#[doc = "Reader of register pwm0_interrupt"]
pub type R = crate::R<u32, super::PWM0_INTERRUPT>;
#[doc = "Writer for register pwm0_interrupt"]
pub type W = crate::W<u32, super::PWM0_INTERRUPT>;
#[doc = "Register pwm0_interrupt `reset()`'s with value 0"]
impl crate::ResetValue for super::PWM0_INTERRUPT {
    type Type = u32;
    #[inline(always)]
