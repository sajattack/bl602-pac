#[doc = "Reader of register pwm4_clkdiv"]
pub type R = crate::R<u32, super::PWM4_CLKDIV>;
#[doc = "Writer for register pwm4_clkdiv"]
pub type W = crate::W<u32, super::PWM4_CLKDIV>;
#[doc = "Register pwm4_clkdiv `reset()`'s with value 0"]
impl crate::ResetValue for super::PWM4_CLKDIV {
    type Type = u32;
    #[inline(always)]
