#[doc = "Reader of register pwm3_thre1"]
pub type R = crate::R<u32, super::PWM3_THRE1>;
#[doc = "Writer for register pwm3_thre1"]
pub type W = crate::W<u32, super::PWM3_THRE1>;
#[doc = "Register pwm3_thre1 `reset()`'s with value 0"]
impl crate::ResetValue for super::PWM3_THRE1 {
    type Type = u32;
    #[inline(always)]
