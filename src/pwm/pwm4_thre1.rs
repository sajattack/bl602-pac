#[doc = "Reader of register pwm4_thre1"]
pub type R = crate::R<u32, super::PWM4_THRE1>;
#[doc = "Writer for register pwm4_thre1"]
pub type W = crate::W<u32, super::PWM4_THRE1>;
#[doc = "Register pwm4_thre1 `reset()`'s with value 0"]
impl crate::ResetValue for super::PWM4_THRE1 {
    type Type = u32;
    #[inline(always)]
