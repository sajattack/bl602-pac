#[doc = "Reader of register pwm0_config"]
pub type R = crate::R<u32, super::PWM0_CONFIG>;
#[doc = "Writer for register pwm0_config"]
pub type W = crate::W<u32, super::PWM0_CONFIG>;
#[doc = "Register pwm0_config `reset()`'s with value 0"]
impl crate::ResetValue for super::PWM0_CONFIG {
    type Type = u32;
    #[inline(always)]
