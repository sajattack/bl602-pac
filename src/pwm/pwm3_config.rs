#[doc = "Reader of register pwm3_config"]
pub type R = crate::R<u32, super::PWM3_CONFIG>;
#[doc = "Writer for register pwm3_config"]
pub type W = crate::W<u32, super::PWM3_CONFIG>;
#[doc = "Register pwm3_config `reset()`'s with value 0"]
impl crate::ResetValue for super::PWM3_CONFIG {
    type Type = u32;
    #[inline(always)]
