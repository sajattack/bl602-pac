#[doc = "Reader of register pwm1_thre2"]
pub type R = crate::R<u32, super::PWM1_THRE2>;
#[doc = "Writer for register pwm1_thre2"]
pub type W = crate::W<u32, super::PWM1_THRE2>;
#[doc = "Register pwm1_thre2 `reset()`'s with value 0"]
impl crate::ResetValue for super::PWM1_THRE2 {
    type Type = u32;
    #[inline(always)]
