#[doc = "Reader of register uart_fifo_config_0"]
pub type R = crate::R<u32, super::UART_FIFO_CONFIG_0>;
#[doc = "Writer for register uart_fifo_config_0"]
pub type W = crate::W<u32, super::UART_FIFO_CONFIG_0>;
#[doc = "Register uart_fifo_config_0 `reset()`'s with value 0"]
impl crate::ResetValue for super::UART_FIFO_CONFIG_0 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Reader of field `uart_dma_rx_en`"]
pub type UART_DMA_RX_EN_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `uart_dma_rx_en`"]
...
#[doc = "Reader of field `uart_dma_tx_en`"]
pub type UART_DMA_TX_EN_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `uart_dma_tx_en`"]
