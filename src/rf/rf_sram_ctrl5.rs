#[doc = "Reader of register rf_sram_ctrl5"]
pub type R = crate::R<u32, super::RF_SRAM_CTRL5>;
#[doc = "Writer for register rf_sram_ctrl5"]
pub type W = crate::W<u32, super::RF_SRAM_CTRL5>;
#[doc = "Register rf_sram_ctrl5 `reset()`'s with value 0"]
impl crate::ResetValue for super::RF_SRAM_CTRL5 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Reader of field `rf_sram_dac_addr_start`"]
pub type RF_SRAM_DAC_ADDR_START_R = crate::R<u16, u16>;
#[doc = "Write proxy for field `rf_sram_dac_addr_start`"]
...
#[doc = "Reader of field `rf_sram_dac_addr_end`"]
pub type RF_SRAM_DAC_ADDR_END_R = crate::R<u16, u16>;
#[doc = "Write proxy for field `rf_sram_dac_addr_end`"]
