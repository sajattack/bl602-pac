#[doc = "Reader of register rf_sram_ctrl4"]
pub type R = crate::R<u32, super::RF_SRAM_CTRL4>;
#[doc = "Writer for register rf_sram_ctrl4"]
pub type W = crate::W<u32, super::RF_SRAM_CTRL4>;
#[doc = "Register rf_sram_ctrl4 `reset()`'s with value 0"]
impl crate::ResetValue for super::RF_SRAM_CTRL4 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Reader of field `rf_sram_dac_done_cnt`"]
pub type RF_SRAM_DAC_DONE_CNT_R = crate::R<u16, u16>;
#[doc = "Write proxy for field `rf_sram_dac_done_cnt`"]
...
#[doc = "Reader of field `rf_sram_dac_sts_clr`"]
pub type RF_SRAM_DAC_STS_CLR_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `rf_sram_dac_sts_clr`"]
...
#[doc = "Reader of field `rf_sram_dac_loop_en`"]
pub type RF_SRAM_DAC_LOOP_EN_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `rf_sram_dac_loop_en`"]
...
#[doc = "Reader of field `rf_sram_dac_en`"]
pub type RF_SRAM_DAC_EN_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `rf_sram_dac_en`"]
...
#[doc = "Reader of field `rf_sram_dac_done`"]
pub type RF_SRAM_DAC_DONE_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `rf_sram_dac_done`"]
