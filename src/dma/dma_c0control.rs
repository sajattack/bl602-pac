#[doc = "Reader of register DMA_C0Control"]
pub type R = crate::R<u32, super::DMA_C0CONTROL>;
#[doc = "Writer for register DMA_C0Control"]
pub type W = crate::W<u32, super::DMA_C0CONTROL>;
#[doc = "Register DMA_C0Control `reset()`'s with value 0"]
impl crate::ResetValue for super::DMA_C0CONTROL {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Reader of field `SLargerD`"]
pub type SLARGERD_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `SLargerD`"]
