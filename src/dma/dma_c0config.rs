#[doc = "Reader of register DMA_C0Config"]
pub type R = crate::R<u32, super::DMA_C0CONFIG>;
#[doc = "Writer for register DMA_C0Config"]
pub type W = crate::W<u32, super::DMA_C0CONFIG>;
#[doc = "Register DMA_C0Config `reset()`'s with value 0"]
impl crate::ResetValue for super::DMA_C0CONFIG {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Reader of field `LLICounter`"]
pub type LLICOUNTER_R = crate::R<u16, u16>;
#[doc = "Write proxy for field `LLICounter`"]
