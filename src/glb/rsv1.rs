#[doc = "Reader of register rsv1"]
pub type R = crate::R<u32, super::RSV1>;
#[doc = "Writer for register rsv1"]
pub type W = crate::W<u32, super::RSV1>;
#[doc = "Register rsv1 `reset()`'s with value 0"]
impl crate::ResetValue for super::RSV1 {
    type Type = u32;
    #[inline(always)]
