#[doc = "Reader of register rsv3"]
pub type R = crate::R<u32, super::RSV3>;
#[doc = "Writer for register rsv3"]
pub type W = crate::W<u32, super::RSV3>;
#[doc = "Register rsv3 `reset()`'s with value 0"]
impl crate::ResetValue for super::RSV3 {
    type Type = u32;
    #[inline(always)]
